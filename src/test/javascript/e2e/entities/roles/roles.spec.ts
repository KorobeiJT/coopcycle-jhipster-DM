...
describe('Roles e2e test', () => {
  ...
  it('should load Roles', async () => {
    ...
    expect(await rolesComponentsPage.getTitle()).to.eq('coopcycleApp.roles.home.title');
  ...
  it('should load create Roles page', async () => {
    ...
    expect(await rolesUpdatePage.getPageTitle()).to.eq('coopcycleApp.roles.home.createOrEditLabel');
  ...
  it('should delete last Roles', async () => {
    ...
    expect(await rolesDeleteDialog.getDialogTitle()).to.eq('coopcycleApp.roles.delete.question');
